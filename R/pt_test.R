...
pt_test <- function(data_merged_drought, drought_panel_dat) {
  ...
  print("Model data saved in: data/all_lt_models.Rdata")
  print("Coefficients of trend saved in: results/linear_unit_trends.xlsx")
  print("Treatment effects with linear trend saved in: results/tes_with_lt.xlsx")
}
