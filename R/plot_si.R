...
plot_si <- function(all_dat) {
  ...
  ggsave("figures/datasets.jpeg", height = 8, width = 6)
  ...
  ggsave("figures/missing_birth.jpeg", width = 3.4, height = 8)
  ...
  ggplot(proportions2, aes(x = proportion, y = country, fill = mar_imp_label)) +
    ...
    scale_fill_manual(values = imp_colors) +
    theme(panel.grid.minor = element_blank())
  ggsave("figures/missing_marriage.jpeg", width = 6, height = 8)
}
