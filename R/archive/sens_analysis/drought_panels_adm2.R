...
# Create drought panel data at the Adm2 level and plot the panels

create_drought_panels_adm2 <- function() {

  # Read in edited drought spreadsheet
  drought_dat <- read_excel("data/emdat/emdat_drought_events_updated.xlsx") %>%
    filter(`Adm2 Analysis`=="Yes") # Select events that will be analysed
  ...
  print("Drought panel data (Adm2) saved in: data/emdat/drought_panel_adm2.Rdata")
  print("Plots (Adm2) saved in: /data/emdat/panel_plots_adm2")
